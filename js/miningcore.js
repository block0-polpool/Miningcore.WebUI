...
// var stratumAddress = "polpool.com";
  ...
  return $.ajax(API + "pools")
    .done(function (data) {
      ...
      $.each(data.pools, function (index, value) {
        ...
        poolCoinTableTemplate += "<td class='card-btn col-hide'>" + language.GoMineText + " " + coinLogo + coinName + "</td>";
    ...
    .fail(function () {
      ...
      poolCoinTableTemplate += "	<h4><i class='fas fa-exclamation-triangle'></i> " + language.WarningText + "</h4>";
      poolCoinTableTemplate += "	<hr>";
      poolCoinTableTemplate += "	<p>" + language.poolmaintenanceText + "</p>";
      poolCoinTableTemplate += "	<p>" + language.tryagainText + "</p>";
  ...
  return $.ajax(API + "pools/" + currentPool + "/miners?page=0&pagesize=20")
    .done(function (data) {
      ...
      if (data.length > 0) {
        ...
        minerList += "<tr><td colspan='4'><div class='Nominerconnected'></div></td></tr>";
      }
  ...
  return $.ajax(API + "pools/" + currentPool + "/blocks?page=0&pageSize=100")
    .done(function (data) {
      ...
      if (data.length > 0) {
        ...
        blockList += "<tr><td colspan='6'><div class='Noblocksfound'></div></td></tr>";
      }
  ...
  return $.ajax(API + "pools/" + currentPool + "/payments?page=0&pageSize=500")
    .done(function (data) {
      ...
      if (data.length > 0) {
        ...
        paymentList += "<tr><td colspan='4'><div class='Nopaymentsfound'></div></td></tr>";
      }
    ...
    .done(function (data) {
      ...
      $.each(data.pools, function (index, value) {
        if (currentPool === value.id) {
          ...
          connectPoolConfig += "<tr><td>" + language.CryptoCoinname + "</td><td>" + coinName + " (" + value.coin.type + ") </td></tr>";
          //connectPoolConfig += "<tr><td>Coin Family line </td><td>" + value.coin.family + "</td></tr>";
          connectPoolConfig += "<tr><td>" + language.CoinAlgorithmText + "</td><td>" + value.coin.algorithm + "</td></tr>";
          connectPoolConfig += "<tr><td>" + language.PoolWalletText + '</td><td><a href="' + value.addressInfoLink + '" target="_blank">' + value.address.substring(0, 12) + " &hellip; " + value.address.substring(value.address.length - 12) + "</a></td></tr>";
          connectPoolConfig += "<tr><td>" + language.PayoutSchemeText + "</td><td>" + value.paymentProcessing.payoutScheme + "</td></tr>";
          connectPoolConfig += "<tr><td>" + language.MinimumPaymentText + "</td><td>" + value.paymentProcessing.minimumPayment + " " + value.coin.type + "</td></tr>";
          if (typeof value.paymentProcessing.minimumPaymentToPaymentId !== "undefined") {
            connectPoolConfig += "<tr><td>" + language.MinimumPayoutText + "</td><td>" + value.paymentProcessing.minimumPaymentToPaymentId + "</td></tr>";
          }
          ...
          $.each(value.ports, function (port, options) {
            ...
            if (typeof options.varDiff !== "undefined" && options.varDiff != null) {
              ...
              connectPoolConfig += language.DifficultyStaticText + " / " + options.difficulty;
            }
      ...
      $("#miner-config").load("poolconfig/" + lang + ".html",
        function (response, status, xhr) {
          if (status == "error") {
            $("#miner-config").load("poolconfig/en.html",
